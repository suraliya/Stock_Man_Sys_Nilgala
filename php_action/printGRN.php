...
$supID = $orderData[2];
////$SupplierName = $orderData[2];
//$SupplierContact = $orderData[3];


//get suplier data
$supDataSql = "SELECT fname, supTp FROM supplier WHERE supID = $supID ";

$getSupData = $connect->query($supDataSql);
$supData = $getSupData->fetch_array();

$SupplierName = $supData[0];
$SupplierContact = $supData[1];
